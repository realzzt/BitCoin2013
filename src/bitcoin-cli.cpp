...
UniValue CallRPC(const string &strMethod, const UniValue &params)
{
	...
	if(mapArgs["-rpcpassword"] == "")
	{
		...
		if(!GetAuthCookie(&strRPCUserColonPass))
			throw runtime_error(strprintf(_("Could not locate RPC credentials. No authentication cookie could be found, and no rpcpassword is set in the configuration file (%s)"), GetConfigFile().string().c_str()));
	}
	else
